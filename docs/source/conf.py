...
# Your codebase uses "Inputs:" instead of the standard "Args:"/"Parameters:" -
# tell napoleon to treat it the same way, so docstrings render instead of
# erroring with "Unexpected indentation".
